...
CONFIG_CONTROLLER_HOST=${ACCESS_IP_V4}

# List the servers on which to install the Compute service.
CONFIG_COMPUTE_HOSTS=${ACCESS_IP_V4}
...
CONFIG_NETWORK_HOSTS=${ACCESS_IP_V4}
...
CONFIG_STORAGE_HOST=${ACCESS_IP_V4}

# (Unsupported!) Server on which to install OpenStack services
# specific to OpenStack Data Processing (sahara).
CONFIG_SAHARA_HOST=${ACCESS_IP_V4}
...
CONFIG_SELFSIGN_CACERT_SUBJECT_CN=packstack-standard

CONFIG_SELFSIGN_CACERT_SUBJECT_MAIL=admin@packstack-standard
...
CONFIG_KEYSTONE_ADMIN_TOKEN=b1268cbe9bbe47138f3991246d033565
...
CONFIG_KEYSTONE_ADMIN_PW=08c33e2592fc4a46
...
# database.
CONFIG_GLANCE_DB_PW=361cee89aae8470e

# Password to use for the Image service to authenticate with the
# Identity service.
CONFIG_GLANCE_KS_PW=a4844d15dd834792
...
# the database.
CONFIG_CINDER_DB_PW=43f510600ae44732
...
CONFIG_CINDER_KS_PW=05cafbadbf4f4509
...
# database.
CONFIG_NOVA_DB_PW=b2dcb3650862402e

# Password to use for the Compute service to authenticate with the
# Identity service.
CONFIG_NOVA_KS_PW=8d0f2de3d30e4be4
...
CONFIG_NEUTRON_KS_PW=3f4c872c2d724bf0

# The password to use for OpenStack Networking to access the
# database.
CONFIG_NEUTRON_DB_PW=fa3a495e46654857
...
CONFIG_NEUTRON_METADATA_PW=49f9f90e765a4d04
...
CONFIG_HORIZON_SECRET_KEY=082c09f4e8c843fdbbcd4695360d12eb
...
# the Identity service.
CONFIG_SWIFT_KS_PW=71c94b5a2c3e46dc
...
CONFIG_SWIFT_HASH=f2b3e8731fa04be9
...
CONFIG_HEAT_AUTH_ENC_KEY=77a128115c6a41ee
...
CONFIG_MONGODB_HOST=${ACCESS_IP_V4}

# IP address of the server on which to install the Redis master
# server.
CONFIG_REDIS_MASTER_HOST=${ACCESS_IP_V4}
...
# Identity service.
CONFIG_AODH_KS_PW=928056a97a164367
...
CONFIG_NAGIOS_PW=8f56d3c25c4f491b
